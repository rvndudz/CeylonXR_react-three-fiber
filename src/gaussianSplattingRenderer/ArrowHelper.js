...
export class ArrowHelper extends THREE.Object3D {
    // Class-level private variable for _axis
    static _axis = new THREE.Vector3();
    ...
    setDirection(dir) {
        if (dir.y > 0.99999) {
            ...
            ArrowHelper._axis.set(dir.z, 0, -dir.x).normalize();
