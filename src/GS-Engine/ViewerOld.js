...
import { Character } from './Character.js';             // <-- ADDED
import { ThirdPersonControls } from './ThirdPersonControls.js'; // <-- ADDED
...
this.setupEventHandlers();
    ...
    setupCustomControls() {
        // Create character & add to scene
        this.character = new Character();
        this.threeScene.add(this.character.group);
    
        // Create our third-person controls
        this.controls = new ThirdPersonControls(this.camera, this.character, this.renderer.domElement);
      }
